...
alias unifi="sudo systemctl start unifi"
alias updateCodelite="python3 ~/ti-software/bmptk/tools/bmptk-mef.py"
#alias nodejs="node"
#alias arm-none-eabi-gcc="${HOME}/opt/gcc-arm-none-eabi-6-2017-q1-update/bin/arm-none-eabi-gcc"

# Exports for Ionic building
export PATH=$PATH:~/Android/Sdk/tools
export PATH=$PATH:~/Android/Sdk/platform-tools
export JAVA_HOME=/usr/local/jdk8
export ANDROID_HOME=~/Android/Sdk
export PATH=${PATH}:$HOME/Android/Sdk/platform-tools:$HOME/Android/tools:$HOME/Android/Sdk/build-tools/26.0.0/
